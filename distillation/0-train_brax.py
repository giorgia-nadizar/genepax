...
INVERTED_DOUBLE_PENDULUM_CONFIG = {
    # --------------------------------------------------------
    # Environment
    # --------------------------------------------------------
    "environment": {
...
SAC_CONFIG = INVERTED_DOUBLE_PENDULUM_CONFIG
...
if __name__ == '__main__':
    ...
    training_config_to_save["num_timesteps"] = training_config["num_timesteps"]
    training_config_to_save["seed"] = training_config["seed"]
