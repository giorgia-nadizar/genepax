...
def run_sym_reg_ga(config: Dict, n_features: int):
    ...
    csv_logger = CSVLogger(
        f'../results/sensitivity/{config["run_name"]}_{n_features}.csv', header=list(metrics.keys())
    )
    ...
    path = f"../results/sensitivity/{conf['run_name']}_{n_features}.pickle"
